...
# All platforms from https://github.com/mitsuhiko/minijinja/releases/tag/2.12.0
PLATFORMS = {
    # macOS
    ...
    "i686-unknown-linux-musl": struct(
        compatible_with = [
            "@platforms//os:linux",
...
# By default all these toolchains are registered by the minijinja_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:minijinja_toolchain",
    toolchain_type = "@rules_minijinja//minijinja:toolchain_type",
)
""".format(
            platform = platform,
