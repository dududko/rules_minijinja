"""Minijinja toolchain implementation.

This module defines the minijinja_toolchain rule and MinijinjaInfo provider
for configuring and accessing the minijinja-cli binary across different platforms.
"""

MinijinjaInfo = provider(
    doc = """Information about the minijinja toolchain.

Provides access to the minijinja-cli binary and associated files needed for
...
def _minijinja_toolchain_impl(ctx):
    ...
    template_variables = platform_common.TemplateVariableInfo({
        "minijinja_BIN": target_tool_path,
    })
    default = DefaultInfo(
...
minijinja_toolchain = rule(
    implementation = _minijinja_toolchain_impl,
    attrs = {
    ...
    doc = """Defines a minijinja compiler/runtime toolchain.
